...
//      Ct_L     Win_L    Alt_L                               SPACE                               Alt_R    FN       Ct_R     Left     Down     Right
    ...
    [0] = LAYOUT(
        ...
        KC_LCTL, KC_LGUI, KC_LALT,                            KC_SPC,                             KC_APP,  KC_RGUI, MO(1),   KC_LEFT, KC_DOWN, KC_RGHT
    ),
    ...
    [1] = LAYOUT(
        ...
        KC_NO,   KC_NO,   KC_NO,   EEP_RST, RESET,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,            KC_PGUP,
        KC_NO,   KC_NO,   KC_NO,   DEBUG,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,            KC_NO,            KC_PGDN,
        KC_NO,            KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   NK_TOGG, NK_ON,   NK_OFF,  KC_NO,   KC_NO,            KC_NO,   KC_MPLY, KC_NO,
        KC_NO,   GUI_ON,  GUI_OFF,                            KC_NO,                              GUI_OFF, GUI_ON,  KC_NO,   KC_MRWD, KC_MSTP, KC_MFFD
    ),
